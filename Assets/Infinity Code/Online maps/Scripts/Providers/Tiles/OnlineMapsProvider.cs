...
public class OnlineMapsProvider
{
    ...
    {
        //added by me 2017.7.31
        mapTypeID = "google.terrain";
        ...
        providers = new []
        {
            ...
            new OnlineMapsProvider("google", "Google Maps")
            {
                ...
                _types = new[]
                {
                    ...
                    new MapType(TERRAIN)
                    {
                        urlWithLabels = "https://mt{rnd0-3}.googleapis.com/vt?pb=!1m4!1m3!1i{zoom}!2i{x}!3i{y}!2m3!1e0!2sm!3i295124088!3m9!2s{lng}!3sKR!5e18!12m1!1e47!12m3!1e37!2m1!1ssmartmaps!4e0"
                    }
                }
            },
